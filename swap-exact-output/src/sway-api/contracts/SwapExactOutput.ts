...
export class SwapExactOutputInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class SwapExactOutput extends Contract {
  static readonly abi = abi;
  static readonly storageSlots = storageSlots;

  declare interface: SwapExactOutputInterface;
  declare functions: {
    main: InvokeFunction<[assets: Vec<AssetIdInput>, output_amount: BigNumberish, maximum_input_amount: BigNumberish, deadline: BigNumberish], BN>;
  };
